...
class InvitationController extends Controller
{
    ...
    {
        $a = $this->tc_hex2rgb($hex1);
        $b = $this->tc_hex2rgb($hex2);
    ...
    private function tc_darken($hex, $amount)
    {
        return $this->tc_mix($hex, '#000000', $amount);
    }

    private function tc_lighten($hex, $amount)
    {
        return $this->tc_mix($hex, '#ffffff', $amount);
    }

    private function tc_rgbstr($hex)
    {
        $r = $this->tc_hex2rgb($hex);
