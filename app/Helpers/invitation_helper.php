    ...
    function get_lang_strings() {
        return [
            ...
            'hero_getting_married' => [
                ...
                'si' => 'අපගේ විවාහ මංගල්‍යයට ඔබගේ සම්භාවනීය පැමිණීම අපේක්ෂා කරමු',
...
if (!function_exists('_invite_date_maps')) {
    function _invite_date_maps() {
        return [
            ...
            'months' => [
                'si' => ['දුරුතු', 'නවාම්', 'මැදින්', 'බක්', 'වෙසක්', 'පොසොන්', 'ඇසළ', 'නිකිණි', 'බිනර', 'වප්', 'ඉල්', 'උඳුවප්'],
