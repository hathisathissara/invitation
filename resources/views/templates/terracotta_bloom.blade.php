...
<div class="fx-controls">
    ...
    <audio id="bg-music" loop preload="none" src="{{ $music_file }}"></audio>
    @endif
</div>
...
<!-- HERO HEADER -->
<div class="hero-header position-relative overflow-hidden text-center shadow-lg border-bottom border-danger border-3" {!! $hero_style !!}>
    ...
    <div class="hero-content">
        ...
        <div class="hero-date-area">
            ...
            <p class="hero-venue mt-3" style="font-family:'Inter',sans-serif; font-size:1.1rem; color:var(--gold);"><i class="fas fa-map-marker-alt"></i> {{ $wedding->venue }}</p>
            @endif
        </div>
    </div>
</div>
            ...
            <div class="event-card col text-end shadow-sm rounded-4 reveal-fx">
                ...
                <div class="event-meta">
                    <div class="event-meta-item">
                        ...
                        <span>{{ t_date($ev->event_date_time) }}</span>
                    </div>
                    <div class="event-meta-item">
                        <i class="far fa-clock"></i>
                        <span>{{ t_time($ev->event_date_time) }}</span>
                    </div>
                    <div class="event-meta-item">
...
<!-- =====================================================================
    ...
    <div style="background: var(--cream-2); border: 2px dashed var(--gold); border-radius: 20px; padding: 30px 20px; text-align: center; margin-bottom: 30px;">
        ...
        @else
            ...
            <h5 class="fw-bold" style="font-family:'Inter', sans-serif; font-size: 0.95rem; color: #1a1a2e; margin-bottom: 6px;">Share your photos</h5>
    ...
    <div class="gallery-grid" id="guest-gallery-grid" style="margin-bottom: 30px;">
        @if($guestImages->count() > 0)
            ...
            <div class="gallery-item" onclick="openLightbox('{{ asset($g_img->image_path) }}')" style="border-color: #22c55e;">
