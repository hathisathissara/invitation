...
<div class="hero reveal">
    <div class="hero-media">
        <div class="hero-media-bg" {!! $hero_style !!}></div>
        <div class="hero-media-overlay"></div>
        <canvas class="hero-scene" id="hero-scene"></canvas>
        <div class="wax-seal">{{ $monogram }}</div>
    </div>
    <div class="hero-panel">
        ...
        <h1 class="couple-title">
            <span class="shimmer-name">{{ $wedding->bride_name }}</span>
            <span class="amp">&amp;</span>
            <span class="shimmer-name">{{ $wedding->groom_name }}</span>
        </h1>
