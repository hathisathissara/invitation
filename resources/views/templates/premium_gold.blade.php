...
<!-- HERO HEADER -->
<div class="hero-header position-relative overflow-hidden text-center" {!! $hero_style !!}>
...
<!-- =====================================================================
    ...
    <div style="background: rgba(249,245,238,0.75); border: 2px dashed var(--gold); border-radius: 20px; padding: 30px 20px; text-align: center; margin-bottom: 30px;">
        ...
        @else
            ...
            <h5 class="fw-bold" style="font-family:'Inter', sans-serif; font-size: 0.95rem; color: var(--navy); margin-bottom: 6px;">Share your photos</h5>
