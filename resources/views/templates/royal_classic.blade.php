...
<div class="hero reveal" id="hero-root">
    <div class="hero-media" {!! $hero_style !!}>
...
@foreach($galleryImages as $img)
                <div class="coverflow-slide" data-index="{{ $cf_i }}" onclick="coverflowClick({{ $cf_i }}, '{{ $img->image_path }}')">
                    <div class="cf-frame">
...
@endif
            ...
            @if (session('status'))
                {!! session('status') !!}
                @if($currentGuest->rsvp_status == 'accepted')
