...
<section class="content-container">
    ...
    <p>By accessing or using Lumos Studio ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms constitute a legally binding agreement between you and Lumos Studio, operated from Colombo, Sri Lanka.</p>

    <h2>2. Description of Service</h2>
    <p>Lumos Studio is a digital wedding invitation platform that enables users to create, customize, and share beautiful wedding invitations online. Our services include:</p>
    <ul>
    ...
    <p>Lumos Studio offers the following plans and add-ons with fixed, one-time flat fees:</p>
    <ul>
    ...
    <p>You retain full ownership of any content you upload or create on the Service, including text, images, and wedding details ("User Content"). By using the Service, you grant Lumos Studio a non-exclusive, worldwide, royalty-free license to use, display, and distribute your User Content solely for the purpose of providing and operating the Service.</p>
    ...
    <p>We strive to keep Lumos Studio available at all times. However, we do not guarantee 100% uptime. The Service may be temporarily unavailable due to maintenance, updates, server issues, or circumstances beyond our control. We will make reasonable efforts to notify users of planned downtime in advance. We are not liable for any loss or inconvenience caused by service interruptions.</p>

    <h2>9. Intellectual Property</h2>
    <p>The Lumos Studio platform, including its design, themes, source code, logos, and all related intellectual property, is owned by Lumos Studio and is protected by applicable copyright and trademark laws. You may not copy, modify, distribute, sell, or lease any part of the Service or its underlying technology without our prior written consent. Themes provided by the Service are licensed for use within the platform only and may not be extracted or repurposed.</p>

    <h2>10. Limitation of Liability</h2>
    <p>To the fullest extent permitted by law, Lumos Studio and its operators, employees, and affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of the Service.</p>
