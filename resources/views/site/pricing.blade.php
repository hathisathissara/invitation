...
@section('title', 'Pricing — Choose Your Wedding Plan')
...
<section style="padding-top:20px;">
    <div class="pricing-grid">
        ...
        <div class="pricing-card reveal">
            ...
            <div>
                <a href="/register" class="btn-primary-gold">
        ...
        <div class="pricing-card popular reveal">
            ...
            <div>
                <a href="/register" class="btn-primary-gold" style="background: linear-gradient(135deg, var(--pink), #be185d); color: white;">
